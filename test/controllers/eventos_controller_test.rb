...
class EventosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evento" do
    assert_difference("Evento.count") do
      post eventos_url, params: { evento: { data_fim: @evento.data_fim, data_inicio: @evento.data_inicio, descricao: @evento.descricao } }
    end
  ...
  test "should update evento" do
    patch evento_url(@evento), params: { evento: { data_fim: @evento.data_fim, data_inicio: @evento.data_inicio, descricao: @evento.descricao } }
